defmodule SymphonyElixir.TestSupport do
  ...
  defp stop_default_http_server_child do
    case default_http_server_child() do
  ...
  defp default_http_server_child do
  ...
  defp workflow_content(overrides) do
    ...
    tracker_image_inputs = Keyword.get(config, :tracker_image_inputs)
    ...
    sections =
      [
        ...
        "  image_inputs: #{yaml_value(tracker_image_inputs)}",
        "polling:",
