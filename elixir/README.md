...
- `agent.max_continuations` caps how many orchestrator-level continuation worker sessions Symphony
  will schedule after a worker exits normally while the issue is still active. Default: `3`.
